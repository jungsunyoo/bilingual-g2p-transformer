...
class Hparams:
    ...
    # prepro
#    parser.add_argument('--vocab_size', default=100000000, type=int)
...
#    parser.add_argument('--vocab_size', default=24, type=int)
    ...
    parser.add_argument('--train1', default='sentences/train.g.reduced.bpe',
                             help="english grapheme training data")
    parser.add_argument('--train2', default='sentences/train.p.reduced.bpe',
                             help="english phoneme training data")
    parser.add_argument('--eval1', default='sentences/eval.g.bpe',
                             help="english grapheme evaluation data")
    parser.add_argument('--eval2', default='sentences/eval.p.bpe',
                             help="english phoneme evaluation data")
#    parser.add_argument('--eval3', default='iwslt2016/prepro/eval.de',
#                             help="english evaluation unsegmented data")
    ## YJS ADDED: MULTI-LANGUAGE
#    parser.add_argument('--language', default='english', help="which language (eng/kor, def=eng)")
    ## vocabulary
